...
<div class="features">
    <div class="feature">
        <img src="<?= base_url('assets/img/'); ?>shipping.png" alt="" class="featureIcon">
        <span class="featureTitle">FREE SHIPPING</span>
        <span class="featureDesc">Free worldwide shipping on all orders.</span>
    </div>
    <div class="feature">
        <img class="featureIcon" src="<?= base_url('assets/img/'); ?>return.png" alt="">
        <span class="featureTitle">30 DAYS RETURN</span>
        <span class="featureDesc">No question return and easy refund in 14 days.</span>
    </div>
    <div class="feature">
        <img class="featureIcon" src="<?= base_url('assets/img/'); ?>gift.png" alt="">
        <span class="featureTitle">GIFT CARDS</span>
        <span class="featureDesc">Buy gift cards and use coupon codes easily.</span>
    </div>
    <div class="feature">
        <img class="featureIcon" src="<?= base_url('assets/img/'); ?>contact.png" alt="">
        <span class="featureTitle">CONTACT US!</span>
        <span class="featureDesc">Keep in touch via email and support system.</span>
    </div>
</div>
<div class="product" id="product">
    <img src="<?= base_url('assets/img/'); ?>air.png" alt="" class="productImg">
    <div class="productDetails">
        <h1 class="productTitle">AIR FORCE</h1>
        <h2 class="productPrice">$199</h2>
        <p class="productDesc">Sepatu terbuat dari karet sintetis.</p>
        <div class="colors">
            <div class="color"></div>
            <div class="color"></div>
        </div>
        ...
        <button class="productButton2"><a href="<?php echo base_url('produk'); ?>" class="productButton">See Another
                Product</a></button>
    </div>
    <!-- card pembelian -->
    <div class="payment">
        ...
        <div class="cardIcons">
            <img src="<?= base_url('assets/img/'); ?>visa.png" width="40" alt="" class="cardIcon">
            <img src="<?= base_url('assets/img/'); ?>master.png" alt="" width="40" class="cardIcon">
        </div>
